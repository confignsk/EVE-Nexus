...
public class CharacterLoyaltyPointsAPI {
        ...
        -> [LoyaltyPoint]
    {
        ...
        let urlString =
            "https://esi.evetech.net/latest/characters/\(characterId)/loyalty/points/?datasource=tranquility"
    ...
    private func saveToDatabase(characterId: Int, data: Data) async throws {
        ...
        guard
            case .success = CharacterDatabaseManager.shared.executeQuery(
                query, parameters: [characterId, jsonString]
            )
        else {
