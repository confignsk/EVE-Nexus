...
struct NotificationRow: View {
    ...
    private var eventTime: Date? {
        guard let eventTimeInterval = notification.content.userInfo["eventTime"] as? TimeInterval
        else {
            return nil
        }
        ...
        VStack(alignment: .leading, spacing: 8) {
            ...
            if let triggerTime = triggerTime {
                HStack {
                    ...
                    Text(
                        NSLocalizedString(
                            "Calendar_Notification_Time", comment: "Notification Time"
                        ) + ": "
            ...
            if let eventTime = eventTime {
                HStack {
                    ...
                    Text(
                        NSLocalizedString("Calendar_Reminder_Event_Time", comment: "Event Time")
