...
class CharacterMailViewModel: ObservableObject {
    ...
    // 获取特定标签下的邮件
    func fetchMailsByLabel(characterId _: Int, labelId: Int) async {
        isLoading = true
        defer { isLoading = false }
    ...
    private func getMockMailsByLabel(labelId: Int) -> [Mail] {
        ...
        case 1:
            return [
                ...
                Mail(
                    id: 2, subject: "重要：军团政策更新", from: "军团长",
        ...
        case 2:
            return [
                Mail(
                    id: 3, subject: "军团每周会议", from: "军团秘书",
                    date: Date().addingTimeInterval(-172_800), isRead: true
                )
            ]
        default:
            return []
