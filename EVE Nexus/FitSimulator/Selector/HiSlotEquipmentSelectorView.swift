...
struct HiSlotEquipmentSelectorView: View {
    ...
    init(
        ...
        // 使用飞船ID构建键名
        let hiSlotGroupIDKey = shipTypeID > 0 ? "LastVisitedHighSlotGroupID_\(shipTypeID)" : "LastVisitedHighSlotGroupID"
        ...
        // 使用飞船ID构建搜索键名
        let hiSlotSearchKey = shipTypeID > 0 ? "LastHighSlotSearchKeyword_\(shipTypeID)" : "LastHighSlotSearchKeyword"
