...
struct MedSlotEquipmentSelectorView: View {
    ...
    init(
        ...
        // 使用飞船ID构建键名
        let midSlotGroupIDKey = shipTypeID > 0 ? "LastVisitedMidSlotGroupID_\(shipTypeID)" : "LastVisitedMidSlotGroupID"
        ...
        // 使用飞船ID构建搜索键名
        let midSlotSearchKey = shipTypeID > 0 ? "LastMidSlotSearchKeyword_\(shipTypeID)" : "LastMidSlotSearchKeyword"
