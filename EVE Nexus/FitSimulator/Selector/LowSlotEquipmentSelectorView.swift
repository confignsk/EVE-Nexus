...
struct LowSlotEquipmentSelectorView: View {
    ...
    init(
        ...
        // 使用飞船ID构建键名
        let lowSlotGroupIDKey =
            shipTypeID > 0 ? "LastVisitedLowSlotGroupID_\(shipTypeID)" : "LastVisitedLowSlotGroupID"
        ...
        // 使用飞船ID构建搜索键名
        let lowSlotSearchKey =
            shipTypeID > 0 ? "LastLowSlotSearchKeyword_\(shipTypeID)" : "LastLowSlotSearchKeyword"
            ...
            if self.allowedTypeIDs.isEmpty {
                ...
                MarketItemTreeSelectorView(
                    ...
                    onItemSelected: { item in
                        ...
                        let lowSlotGroupIDKey =
                            shipTypeID > 0
                                ? "LastVisitedLowSlotGroupID_\(shipTypeID)"
                                : "LastVisitedLowSlotGroupID"
                        let lowSlotSearchKey =
                            shipTypeID > 0
