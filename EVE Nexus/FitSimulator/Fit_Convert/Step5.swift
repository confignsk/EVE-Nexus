...
class Step5 {
    ...
    /// - Returns: 修正后的飞船数据
    private func applyVelocityCorrection(ship: SimShipOutput, propulsionModule: SimModuleOutput) -> SimShipOutput {
        ...
        Logger.info("推进模块属性 - speedFactor: \(speedFactor), speedBoostFactor: \(speedBoostFactor), massAddition: \(massAddition)")
        ...
        Logger.info("速度修正计算 - velocityBoost: \(velocityBoost), 修正后velocityBoost: \(correctedVelocityBoost)")
